...
!function(e, t) {
    ...
    const zt = {
      ...
      , tn = e => {
        ...
        e.theme && !["light", "dark", "auto", "borderless", "embed-iframe"].includes(e.theme) && u(`Invalid theme "${e.theme}". Expected "light", "dark", "auto", "borderless", or "embed-iframe"`);
        for (const t in e)
            Gt(t),
            e.toast && Qt(t),
            en(t)
    ...
    var An = Object.freeze({
        ...
        bindClickHandler: function() {
            wn[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"] = this,
    ...
    function _n(e) {
        !function(e) {
            e.inputValidator || ("email" === e.input && (e.inputValidator = Vn),
